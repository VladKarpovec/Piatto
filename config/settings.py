...
# --- ALLOWED_HOSTS (надійна обробка всіх випадків) ---
# дефолт для локалки + твій Render-домен
_default_hosts = [
    "piatto-3.onrender.com",  # твій сервіс
    ".onrender.com",             # усі сабдомени Render
...
# --- CSRF (потрібно для форм/POST на Render) ---
CSRF_TRUSTED_ORIGINS = [
    "https://piatto-n3kn.onrender.com",
    "https://*.onrender.com",
]
